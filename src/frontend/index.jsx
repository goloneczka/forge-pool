  ...
  const setChoicesOnInit = () => {
    Promise.all([invoke('getUserOutputs'), invoke('getAllOutputs')]).then(responses => {
      ...
      setChoices(_ => [
        ...
        { id: 1, checkbox: {name: 'Checkbox1', isChecked: userChoices.includes(0)}, question: config.question_1, votes: votes.get(1), isWinning: winningVotes === votes.get(1)},
        { id: 2, checkbox: {name: 'Checkbox2', isChecked: userChoices.includes(0)}, question: config.question_2, votes: votes.get(2), isWinning: winningVotes === votes.get(2)},
        { id: 3, checkbox: {name: 'Checkbox3', isChecked: userChoices.includes(0)}, question: config.question_3, votes: votes.get(3), isWinning: winningVotes === votes.get(3)},
        { id: 4, checkbox: {name: 'Checkbox4', isChecked: userChoices.includes(0)}, question: config.question_4, votes: votes.get(4), isWinning: winningVotes === votes.get(4)},
        { id: 5, checkbox: {name: 'Checkbox5', isChecked: userChoices.includes(0)}, question: config.question_5, votes: votes.get(5), isWinning: winningVotes === votes.get(5)},
        { id: 6, checkbox: {name: 'Checkbox6', isChecked: userChoices.includes(0)}, question: config.question_6, votes: votes.get(6), isWinning: winningVotes === votes.get(6)},
        { id: 7, checkbox: {name: 'Checkbox7', isChecked: userChoices.includes(0)}, question: config.question_7, votes: votes.get(7), isWinning: winningVotes === votes.get(7)},
        { id: 8, checkbox: {name: 'Checkbox8', isChecked: userChoices.includes(0)}, question: config.question_8, votes: votes.get(8), isWinning: winningVotes === votes.get(8)},
        { id: 9, checkbox: {name: 'Checkbox9', isChecked: userChoices.includes(0)}, question: config.question_9, votes: votes.get(9), isWinning: winningVotes === votes.get(9)}
      ]);
